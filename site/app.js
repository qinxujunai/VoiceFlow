const copy = {
  zh: {
    ...
    nextBilingualBody: "SenseVoice 继续作为低配置默认；Qwen3 只作为可下载实验候选，数据没有胜出就不宣称更强。",
  ...
  en: {
    ...
    nextBilingualBody: "SenseVoice remains the low-spec default. Qwen3 is an optional lab candidate and is never called stronger without winning the data.",
