const copy = {
  zh: {
    ...
    releaseStatus: "当前安装包未代码签名，Windows 可能显示安全提示。",
    demoAlt: "VoiceFlow 胶囊显示实时文字，终稿原位确认后安静消失",
    ...
    valueEverywhere: "常用输入框",
    valueEverywhereBody: "停止时仍在普通应用，就发送一次粘贴；明确不可输入时自动保留在剪贴板。",
    valueRecoveryLabel: "结果不会丢",
    valueRecovery: "始终可找回",
    valueRecoveryBody: "即使没有粘贴成功，完整文字仍在剪贴板和可随时清空的本地历史中。",
    nextEyebrow: "本版本 · 可靠性升级",
    nextTitle: "先保证每一句都能找回，再谈更聪明。",
    nextBody: "v__VOICEFLOW_VERSION__ 聚焦长时间听写、真实剪贴板验证、焦点安全与崩溃恢复。先保证每一句有去处，再优化速度与准确率。",
    nextRecoveryTitle: "零丢失交付",
    nextRecoveryBody: "先保存、再校验、后粘贴。停止时仍在普通应用，就发送一次粘贴；明确受限时保留剪贴板。",
    nextBilingualTitle: "诚实的中英模型",
    nextBilingualBody: "默认安装已经包含完整离线识别能力，无需下载或切换模型；内部候选只有通过同机质量门槛后才会进入产品决策。",
    evidenceBadge: "发布前验证",
    evidenceTitle: "不是演示，是发布门槛",
    metricLatency: "快捷键序列",
    metricCer: "录音生命周期",
    metricMemory: "验证范围",
    metricScopeValue: "全量",
    evidenceNote: "这些是工程压力与回归测试，不等同于自然语料准确率；未完成的准确率证据不会写成宣传结论。",
  ...
  en: {
    ...
    compatibility: "Windows 10 / 11 · x64 · v__VOICEFLOW_VERSION__",
    releaseStatus: "The current installer is not code-signed, so Windows may show a security prompt.",
    demoAlt: "The VoiceFlow capsule shows live text, confirms the final in place, then quietly disappears",
    ...
    valueEverywhere: "Common text fields",
    valueEverywhereBody: "At stop time, VoiceFlow sends one paste to the current ordinary app; clearly blocked targets fall back to the clipboard.",
    valueRecoveryLabel: "Your words remain",
    valueRecovery: "Always recoverable",
    valueRecoveryBody: "If paste misses, the complete text stays in the clipboard and local history, which you can clear at any time.",
    nextEyebrow: "This release · reliability upgrade",
    nextTitle: "Make every word recoverable before making it smarter.",
    nextBody: "v__VOICEFLOW_VERSION__ focuses on long-form dictation, verified clipboard delivery, focus safety, and crash recovery. Every result gets a safe destination before speed and accuracy are optimized.",
    nextRecoveryTitle: "Zero-loss delivery",
    nextRecoveryBody: "Save first, verify second, paste last. At stop time, VoiceFlow sends one paste to the current ordinary app; clearly restricted targets keep the clipboard fallback.",
    nextBilingualTitle: "Honest bilingual models",
    nextBilingualBody: "The default install already includes complete offline recognition with no model downloads or switching. Internal candidates stay out of the product until they pass the same-machine quality gate.",
    evidenceBadge: "Pre-release verification",
    evidenceTitle: "A release gate, not a demo",
    metricLatency: "Hotkey sequences",
    metricCer: "Recording lifecycles",
    metricMemory: "Verification scope",
    metricScopeValue: "Full suite",
    evidenceNote: "These are engineering stress and regression tests, not natural-speech accuracy claims. Incomplete accuracy evidence is never marketed as a conclusion.",
