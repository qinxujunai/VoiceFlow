const copy = {
  zh: {
    ...
    releaseStatus: "当前下载仍是 v0.2.2 稳定版；旗舰可靠性升级正在本地验证，尚未替换安装包。",
    ...
    nextEyebrow: "下一版本 · 开发预览",
    nextTitle: "先保证每一句都能找回，再谈更聪明。",
    nextBody: "这一轮升级聚焦一小时听写、真实剪贴板验证、焦点安全与崩溃恢复。以下能力仍在本地测试，不属于当前下载的 v0.2.2 安装包。",
    nextRecoveryTitle: "零丢失交付",
    nextRecoveryBody: "先保存、再校验、后粘贴。未知输入框只复制；任意阶段中断都保留文字或恢复录音。",
    nextBilingualTitle: "诚实的中英模型",
    nextBilingualBody: "默认安装已经包含完整离线识别能力，无需下载或切换模型；内部候选只有通过同机质量门槛后才会进入产品决策。",
    evidenceBadge: "同机初步语料",
    evidenceTitle: "极速听写 · SenseVoice",
    metricLatency: "短句 P95",
    metricCer: "Clean CER",
    metricMemory: "峰值内存",
    evidenceNote: "样本规模尚不足以代表所有口音；正式推荐仍需通过 160 条授权自然语料。",
  ...
  en: {
    ...
    compatibility: "Windows 10 / 11 · x64 · v0.2.2",
    releaseStatus: "The download remains stable v0.2.2. The flagship reliability upgrade is still under local validation and has not replaced the installer.",
    ...
    nextEyebrow: "Next release · development preview",
    nextTitle: "Make every word recoverable before making it smarter.",
    nextBody: "This upgrade focuses on hour-long dictation, verified clipboard delivery, focus safety, and crash recovery. These capabilities remain in local testing and are not included in the current v0.2.2 installer.",
    nextRecoveryTitle: "Zero-loss delivery",
    nextRecoveryBody: "Save first, verify second, paste last. Unknown fields receive clipboard-only delivery, and interruptions retain text or recoverable audio.",
    ...
    evidenceBadge: "Preliminary same-machine corpus",
    evidenceTitle: "Fast Dictation · SenseVoice",
    metricLatency: "Short P95",
    metricCer: "Clean CER",
    metricMemory: "Peak memory",
    evidenceNote: "The sample is too small to represent every accent. Promotion still requires 160 authorized natural utterances.",
