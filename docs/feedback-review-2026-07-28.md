...
| F07 | Capsule text appears in chunks | Closed for the current candidate | Confirmed graphemes reveal at a fixed 48 ms rhythm with no acceleration, replay, or reverse motion. A small bilingual first pass now handles Chinese and English; SenseVoice remains the final authority. |
