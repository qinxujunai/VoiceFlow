...
- **智能录音** — 按右 Ctrl 开始说话，安静 1.5 秒自动停止粘贴；长段口述用 Ctrl+Shift+Win 切换模式
- **流式显示** — 说话时文字实时出现在悬浮条上
...
| 功能 | 快捷键 | 说明 |
|------|--------|------|
| Push-to-Talk | **右 Ctrl** | 按一下开始说话，安静 1.5 秒自动停止，文字粘贴 |
| Toggle 模式 | **Ctrl+Shift+Win** | 按一下开始，再按一下停止。适合长段口述 |
| 取消录音 | **Esc** | 丢弃本次录音 |
| 添加修正 | **Ctrl+Alt+H** | 弹出输入框，添加错误识别→正确写法的映射 |
...
启动后托盘出现 VoiceFlow 图标。按 **右 Ctrl** 开始说话，安静 1.5 秒后文字自动粘贴。
